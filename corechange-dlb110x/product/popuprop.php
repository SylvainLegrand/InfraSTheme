...
foreach($infoprod as $prodid => $vals)
{
	...
	if ($vals['type'] == 1) print img_object($langs->trans("ShowService"), "service", 'class="img16"');	// InfraS change
	else print img_object($langs->trans("ShowProduct"), "product", 'class="img16"');	// InfraS change
	print " ";
	print $vals['ref'].'</a></td>';
	print '<td>';
