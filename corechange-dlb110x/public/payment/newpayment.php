...
// Define urllogo
$urllogo = '';
//$urllogofull = '';	// InfraS change
if (!empty($logosmall) && is_readable($conf->mycompany->dir_output.'/logos/'.$logosmall))	// InfraS delete "/thumbs/"
{
	$urllogo = DOL_URL_ROOT.'/viewimage.php?modulepart=mycompany&amp;entity='.$conf->entity.'&amp;file='.urlencode('logos/'.$logosmall);	// InfraS delete "/thumbs/"
//	$urllogofull = $dolibarr_main_url_root.'/viewimage.php?modulepart=mycompany&entity='.$conf->entity.'&file='.urlencode('logos/thumbs/'.$logosmall);	// InfraS change
	$width = 1080;	// InfraS change 150 to 1080
}
elseif (!empty($logo) && is_readable($conf->mycompany->dir_output.'/logos/'.$logo))
{
	$urllogo = DOL_URL_ROOT.'/viewimage.php?modulepart=mycompany&amp;entity='.$conf->entity.'&amp;file='.urlencode('logos/'.$logo);
//	$urllogofull = $dolibarr_main_url_root.'/viewimage.php?modulepart=mycompany&entity='.$conf->entity.'&file='.urlencode('logos/'.$logo);	// InfraS change
	$width = 1080;	// InfraS change 150 to 1080
}
...
if ($urllogo)
{
	print '<div>';	// InfraS delete 'class="backgreypublicpayment"'
	print '<div class="logopublicpayment">';
	print '<img id="dolpaymentlogo" src="'.$urllogo.'"';
	if ($width) print ' style="max-width: '.$width.'px; max-height: 250px;"';	// InfraS change 'width' by 'max-width' and add 'max-height: 250px;'
	print '>';
	print '</div>';
...
if (empty($text))
{
	$text .= '<tr><td class="textpublicpayment" style="font-size: 24px;"><br><strong>'.$langs->trans("WelcomeOnPaymentPage").'</strong></td></tr>'."\n";	// InfraS add  style="font-size: 24px;"
