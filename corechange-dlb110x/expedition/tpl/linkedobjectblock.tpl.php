...
$linkedObjectBlock = dol_sort_array($linkedObjectBlock, 'date', 'desc', 0, 0, 1);	// InfraS add
$total = 0;
$ilink = 0;
foreach ($linkedObjectBlock as $key => $objectlink)
{
    ...
    <tr class="<?php echo $trclass; ?>">
        <td class="linkedcol-element"><?php echo $langs->trans("Shipment"); ?></td>
        <td class="linkedcol-name"><?php echo $objectlink->getNomUrl(1); ?></td>
		<td class="linkedcol-ref"><?php echo $objectlink->ref_customer; ?></td>
