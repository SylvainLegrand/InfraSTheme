...
if ($step == 1 || !$datatoimport)
{
	...
	if (count($objimport->array_import_module))
	{
		...
		foreach ($sortedarrayofmodules as $key => $value)
		{
			...
			print $titleofmodule;
			print '</td><td>';
			print img_object($objimport->array_import_module[$key]->getName(),$objimport->array_import_icon[$key], 'style="max-height:16px;"').' ';	// InfraS add ", 'style="max-height:16px;"'"
...
if ($step == 2 && $datatoimport)
{
	...
	print '<td>';
	print img_object($objimport->array_import_module[0]->getName(), $objimport->array_import_icon[0], 'style="max-height:16px;"').' ';	// InfraS add ", 'style="max-height:16px;"'"
...
if ($step == 4 && $datatoimport)
{
	...
	foreach ($fieldstarget as $code=>$label)
	{
		...
		print '<td class="nowrap" style="font-weight: normal">=>'.img_object('', $entityicon, 'style="max-height:16px;"').' '.$langs->trans($entitylang).'</td>';	// InfraS add ", 'style="max-height:16px;"'"
