...
print img_picto('', 'globe', 'class="img16"').' '.$langs->trans("ToOfferALinkForOnlinePaymentOnFreeAmount", $servicename).':<br>';	// InfraS change
print '<strong class="wordbreak">'.getOnlinePaymentUrl(1, 'free')."</strong><br><br>\n";
if (!empty($conf->commande->enabled))
{
    print '<div id="order"></div>';
    print img_picto('', 'globe', 'class="img16"').' '.$langs->trans("ToOfferALinkForOnlinePaymentOnOrder", $servicename).':<br>';	// InfraS change
...
if (!empty($conf->facture->enabled))
{
    ...
    print img_picto('', 'globe', 'class="img16"').' '.$langs->trans("ToOfferALinkForOnlinePaymentOnInvoice", $servicename).':<br>';	// InfraS change
...
if (!empty($conf->contrat->enabled))
{
    ...
    print img_picto('', 'globe', 'class="img16"').' '.$langs->trans("ToOfferALinkForOnlinePaymentOnContractLine", $servicename).':<br>';	// InfraS change
...
if (!empty($conf->adherent->enabled))
{
    ...
    print img_picto('', 'globe', 'class="img16"').' '.$langs->trans("ToOfferALinkForOnlinePaymentOnMemberSubscription", $servicename).':<br>';	// InfraS change
...
if (!empty($conf->don->enabled))
{
	...
	print img_picto('', 'globe', 'class="img16"').' '.$langs->trans("ToOfferALinkForOnlinePaymentOnDonation", $servicename).':<br>';	// InfraS change
