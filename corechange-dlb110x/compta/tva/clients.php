...
$user_static = new User($db);	// InfraS add
            ...
            if (is_array($x_both[$thirdparty_id]['coll']['detail']))
            {
                ...
                foreach ($x_both[$thirdparty_id]['coll']['detail'] as $index => $fields) {
                    ...
                    if ($fields['pid']) {
                        ...
                        if ($type) {
                            $text = img_object($langs->trans('Service'), 'service', 'class="img16"');	// InfraS change
                        } else {
                            $text = img_object($langs->trans('Product'), 'product', 'class="img16"');	// InfraS change
                        }
