...
function show_theme($fuser,$edit=0,$foruserprofile=false)
{
	...
	else
	{
		...
		if ($edit)
		{
	   	...
	   	else
	   	{
			...
			if ($color) print '<input type="text" class="colorthumb" disabled="disabled" style="padding: 1px; margin-top: 0; margin-bottom: 0; color: #'.txt_color($color).'; background-color: #'.$color.'" value="'.$color.'">';
	...
	else
	{
		...
		else
		{
			...
			if ($color)
			{
				if ($color != 'edf4fb') print '<input type="text" class="colorthumb" disabled="disabled" style="padding: 1px; margin-top: 0; margin-bottom: 0; color: #'.txt_color($color).'; background-color: #'.$color.'" value="'.$color.'">';
				else print $langs->trans("Default");
			}
