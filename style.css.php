 ...
 * Copyright (C) 2017-2018		Sylvain Legrand		    <sylvain.legrand@infras.fr>
 *
...
/**
 *		\file       htdocs/theme/infras/style.css.php
...
$fontlist='cambria, roboto, arial, tahoma, verdana, helvetica';    //$fontlist='verdana,helvetica,arial,sans-serif';
$img_head='';
...
{
	$colorbacklinepairhover				= join(',',colorStringToArray($colorbacklinepairhover));	// Normalize value to 'x,y,z'
	$colortexthover						= txt_color($colorbacklinepairhover);
	if ($colortexthover == '000000')	$colortexthover		= '202020';
}	// if ($colorbacklinepairhover != '')
else									$colortexthover		= '202020';
...
$colortexthover						= join(',',colorStringToArray($colortexthover));
...
print '$colortexthover='.$colortexthover."\n";
...
/* InfraS											                              */
/* ============================================================================== */
div.divlogofpreviouscustomerprice img:not(.pictotitle) {
	max-height: 16px;
}
div#iddivjstreecontrol img {
	max-height: 16px;
}
.tableforfield img {
	max-height: 16px;
...
.login_table input#username, .login_table input#password {
	width: 200px;
}
...
table.login_table_securitycode span:not(.fa) {
    opacity: 0.5;
	margin-top: 2px;
}
...
table.login_table_securitycode td:nth-of-type(1) {
	width: 16px;
}
table.login_table_securitycode td:nth-of-type(2) {
	width: 280px;
}
...
.button, .butAction, input[name="sbmtConnexion"] {
	<?php if ($usegradient) { ?>
...
.butActionDelete, .buttonDelete {
	...
	<?php if ($usegradient) { ?>
		background-image: -o-linear-gradient(bottom, rgba(255, 170, 0, 0.3) 0%, rgba(255, 170, 0, 1) 100%);
		background-image: -moz-linear-gradient(bottom, rgba(255, 170, 0, 0.3) 0%, rgba(255, 170, 0, 1) 100%);
		background-image: -webkit-linear-gradient(bottom, rgba(255, 170, 0, 0.3) 0%, rgba(255, 170, 0, 1) 100%);
		background-image: -ms-linear-gradient(bottom, rgba(255, 170, 0, 0.3) 0%, rgba(255, 170, 0, 1) 100%);
		background-image: linear-gradient(to bottom, rgba(255, 170, 0, 0.3) 0%, rgba(255, 170, 0, 1) 100%);
	<?php } else { ?>
...
.button:disabled, .butAction:disabled, input[name="sbmtConnexion"]:disabled, .butActionDelete:disabled, .buttonDelete:disabled, butActionRefused, buttonRefused {
    cursor: not-allowed;
	...
	<?php if ($usegradient) { ?>
		...
		background-image: -webkit-linear-gradient(bottom, rgba(255, 255, 255, 0.3) 0%, rgba(230, 230, 230, 1) 100%);
		background-image: -ms-linear-gradient(bottom, rgba(255, 255, 255, 0.3) 0%, rgba(230, 230, 230, 1) 100%);
		background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0.3) 0%, rgba(230, 230, 230, 1) 100%);
	<?php } else { ?>
...
.button:focus:not(:active), .butAction:focus:not(:active), input[name="sbmtConnexion"]:focus:not(:active), .button:hover:not(:active), .butAction:hover:not(:active), input[name="sbmtConnexion"]:hover:not(:active) {
	-webkit-box-shadow: 0px 0px 10px 3px rgba(<?php echo $colorbackhmenu1; ?>, 0.2), 3px 3px rgba(0, 0, 0, 0.1);
	-moz-box-shadow: 0px 0px 10px 3px rgba(<?php echo $colorbackhmenu1; ?>, 0.2), 3px 3px rgba(0, 0, 0, 0.1);
	box-shadow: 0px 0px 10px 3px rgba(<?php echo $colorbackhmenu1; ?>, 0.2), 3px 3px rgba(0, 0, 0, 0.1);
}

.buttonDelete:focus:not(:active), .butActionDelete:focus:not(:active), .buttonDelete:hover:not(:active), .butActionDelete:hover:not(:active) {
	-webkit-box-shadow: 0px 0px 10px 3px rgba(255, 170, 0, 0.2), 3px 3px rgba(0, 0, 0, 0.1);
	-moz-box-shadow: 0px 0px 10px 3px rgba(255, 170, 0, 0.2), 3px 3px rgba(0, 0, 0, 0.1);
	box-shadow: 0px 0px 10px 3px rgba(255, 170, 0, 0.2), 3px 3px rgba(0, 0, 0, 0.1);
}

.button:active, .butAction:active, input[name="sbmtConnexion"]:active, .buttonDelete:active, .butActionDelete:active {
...
table.liste, table.noborder, table.formdoc, div.noborder {
	...
	border-left-width: <?php echo $borderwith ?>px;
	border-left-color: rgb(<?php echo $colortopbordertitle1 ?>);
...
table.liste td, table.noborder td, div.noborder form div none:.tdsetuppicto {
...
.noborder > tbody > tr:nth-child(even) td {
	background: linear-gradient(to top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	background: -o-linear-gradient(top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	background: -moz-linear-gradient(top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	background: -webkit-linear-gradient(top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	background: -ms-linear-gradient(top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	font-family: <?php print $fontlist ?>;
	border: 0px;
	margin-bottom: 1px;
	color: #202020;
...
.noborder > tbody > tr:nth-child(odd) td {
	background: linear-gradient(to top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	background: -o-linear-gradient(top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	background: -moz-linear-gradient(top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	background: -webkit-linear-gradient(top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	background: -ms-linear-gradient(top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	font-family: <?php print $fontlist ?>;
	border: 0px;
	margin-bottom: 1px;
	color: #202020;
...
<?php if ($colorbacklinepairhover) { ?>
	<?php if ($usegradient) { ?>
		background-image: -o-linear-gradient(top,		rgba(<?php echo $colorbacklinepairhover; ?>,1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>,0.1) 100%) !important;
		background-image: -moz-linear-gradient(top,		rgba(<?php echo $colorbacklinepairhover; ?>,1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>,0.1) 100%) !important;
		background-image: -webkit-linear-gradient(top,	rgba(<?php echo $colorbacklinepairhover; ?>,1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>,0.1) 100%) !important;
		background-image: -ms-linear-gradient(top,		rgba(<?php echo $colorbacklinepairhover; ?>,1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>,0.1) 100%) !important;
		background-image: linear-gradient(to top,		rgba(<?php echo $colorbacklinepairhover; ?>,1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>,0.1) 100%) !important;
	<?php } else { ?>
...
.oddeven:hover, .evenodd:hover, .impair:hover, .pair:hover:not(.nohoverpair)
{
	color: rgb(<?php print $colortexthover; ?>);
}
...
.liste > tbody > tr:nth-child(even):not(.liste_titre):hover, .liste > tbody > tr:nth-child(odd):not(.liste_titre):hover {
	<?php if ($colorbacklinepairhover) { ?>
		<?php if ($usegradient) { ?>
			background-image: -o-linear-gradient(top,		rgba(<?php echo $colorbacklinepairhover; ?>,1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>,0.1) 100%) !important;
			background-image: -moz-linear-gradient(top,		rgba(<?php echo $colorbacklinepairhover; ?>,1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>,0.1) 100%) !important;
...
.noborder > tbody > tr:nth-child(even):not(.liste_titre, .liste_titre_filter), .liste > tbody > tr:nth-child(even):not(.liste_titre, .liste_titre_filter) {
	background: linear-gradient(to top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	background: -o-linear-gradient(top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	background: -moz-linear-gradient(top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
	background: -webkit-linear-gradient(top, rgb(<?php echo $colorbacklineimpair1; ?>) 85%, rgb(<?php echo $colorbacklineimpair2; ?>) 100%);
...
.noborder > tbody > tr:nth-child(even):not(:last-child) td:not(.liste_titre, .liste_titre_filter), .liste > tbody > tr:nth-child(even):not(:last-child) td:not(.liste_titre, .liste_titre_filter) {
	border-bottom: 1px solid #ddd;
}

.noborder > tbody > tr:nth-child(odd):not(.liste_titre, .liste_titre_filter), .liste > tbody > tr:nth-child(odd):not(.liste_titre, .liste_titre_filter) {
	background: linear-gradient(to top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	background: -o-linear-gradient(top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	background: -moz-linear-gradient(top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
	background: -webkit-linear-gradient(top, rgb(<?php echo $colorbacklinepair1; ?>) 85%, rgb(<?php echo $colorbacklinepair2; ?>) 100%);
...
.noborder > tbody > tr:nth-child(odd):not(:last-child) td:not(.liste_titre, .liste_titre_filter), .liste > tbody > tr:nth-child(odd):not(:last-child) td:not(.liste_titre, .liste_titre_filter) {
	border-bottom: 1px solid #ddd;
}
...
span.boxstatsindicator img {
	max-height: 16px;
}
div.boxdraggable img {
	max-height: 16px;
}
.classfortooltip img {
	max-height: 16px;
...
.dashboardlinelatecoin {
    ...
    background-color: rgba(188, 44, 0, 1);
    color: #FFFFFF ! important;
    border-radius: .25em;
}
.boxtable {
...
.select2-search-choice-dolibarr img {
	max-height: 16px;
}
