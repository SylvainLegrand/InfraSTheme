...
input:not(.button), input.flat, textarea, textarea.flat, form.flat select, select, select.flat, .dataTables_length label select {
    font-family: <?php print $fontlist ?>;
    outline: none;
...
.div-table-responsive img:not(.img_logo) {
	max-height: 16px;
}
div.fiche {
	/* text-align: justify; */
...
/* ============================================================================== */
#id-right {
	transition: padding-left 500ms ease, margin-left 500ms ease;
}
...
div.fichehalfleft:not(.boxhalfleft) img:not(.pictotitle) {
	max-height: 16px;
}
...
<?php if (GETPOST('optioncss', 'aZ09') == 'print') {  ?>
	display:none;
<?php } else { ?>
	padding-<?php echo $right; ?>: <?php echo ($maxwidthloginblock); ?>px;
<?php } ?>
...
table.liste tr:last-of-type td:not(.tdtop), table.noborder:not(#tablelines) tr:last-of-type td, table.formdoc tr:last-of-type td, div.noborder tr:last-of-type td {
	border-bottom-width: 1px;
	border-bottom-color: rgb(<?php echo $colortopbordertitle1 ?>);
	border-bottom-style: solid;
}
...
.liste_titre_filter {
	background-image: -o-linear-gradient(top,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(top,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(top,	rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: -ms-linear-gradient(top,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: linear-gradient(to top,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-repeat: repeat-x;
...
table.liste td, table.noborder td, div.noborder form div, table.tableforservicepart1 td, table.tableforservicepart2 td {
	...
	/* line-height: <?php echo $dropdownLineHeight; ?>;	*/ /* This create trouble on cell login on list of last events of a contract	*/
}
...
.oddeven:hover, .evenodd:hover, .impair:hover, .pair:hover, .menu_titre:hover , .menu_contenu:hover:not(#menu_contenu_logo)
{
	background-image: -o-linear-gradient(bottom,		rgba(<?php echo $colorbacklinepairhover; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(bottom,		rgba(<?php echo $colorbacklinepairhover; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(bottom,	rgba(<?php echo $colorbacklinepairhover; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>, 1) 100%) !important;
	background-image: -ms-linear-gradient(bottom,		rgba(<?php echo $colorbacklinepairhover; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>, 1) 100%) !important;
	background-image: linear-gradient(to bottom,		rgba(<?php echo $colorbacklinepairhover; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairhover; ?>, 1) 100%) !important;
}
...
/* Info admin */
div.info {
	border-left: solid 3px rgb(<?php echo $colorBorderInfo; ?>);
	border-top: solid 3px rgb(<?php echo $colorBorderInfo; ?>);
	border-right: solid 1px rgb(<?php echo $colorBorderInfo; ?>);
	border-bottom: solid 1px rgb(<?php echo $colorBorderInfo; ?>);
    padding-top: 8px;
    padding-left: 10px;
    padding-right: 4px;
    padding-bottom: 8px;
    margin: 1em 0em 1em 0em;
	background-image: -o-linear-gradient(bottom,		rgba(<?php echo $colorBackInfo; ?>, 0.1) 0%, rgba(<?php echo $colorBackInfo; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(bottom,		rgba(<?php echo $colorBackInfo; ?>, 0.1) 0%, rgba(<?php echo $colorBackInfo; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(bottom,	rgba(<?php echo $colorBackInfo; ?>, 0.1) 0%, rgba(<?php echo $colorBackInfo; ?>, 1) 100%) !important;
	background-image: -ms-linear-gradient(bottom,		rgba(<?php echo $colorBackInfo; ?>, 0.1) 0%, rgba(<?php echo $colorBackInfo; ?>, 1) 100%) !important;
	background-image: linear-gradient(to bottom,		rgba(<?php echo $colorBackInfo; ?>, 0.1) 0%, rgba(<?php echo $colorBackInfo; ?>, 1) 100%) !important;
}

/* Warning message */
div.warning {
	border-left: solid 3px rgb(<?php echo $colorBorderWarning; ?>);
	border-top: solid 3px rgb(<?php echo $colorBorderWarning; ?>);
	border-right: solid 1px rgb(<?php echo $colorBorderWarning; ?>);
	border-bottom: solid 1px rgb(<?php echo $colorBorderWarning; ?>);
	padding-top: 8px;
	padding-left: 10px;
	padding-right: 4px;
	padding-bottom: 8px;
	margin: 1em 0em 1em 0em;
    background: #fcf8e3;
	background-image: -o-linear-gradient(bottom,		rgba(<?php echo $colorBackWarning; ?>, 0.1) 0%, rgba(<?php echo $colorBackWarning; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(bottom,		rgba(<?php echo $colorBackWarning; ?>, 0.1) 0%, rgba(<?php echo $colorBackWarning; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(bottom,	rgba(<?php echo $colorBackWarning; ?>, 0.1) 0%, rgba(<?php echo $colorBackWarning; ?>, 1) 100%) !important;
	background-image: -ms-linear-gradient(bottom,		rgba(<?php echo $colorBackWarning; ?>, 0.1) 0%, rgba(<?php echo $colorBackWarning; ?>, 1) 100%) !important;
	background-image: linear-gradient(to bottom,		rgba(<?php echo $colorBackWarning; ?>, 0.1) 0%, rgba(<?php echo $colorBackWarning; ?>, 1) 100%) !important;
}
...
/* Error message */
div.error {
	border-left: solid 3px rgb(<?php echo $colorBorderError; ?>);
	border-top: solid 3px rgb(<?php echo $colorBorderError; ?>);
	border-right: solid 1px rgb(<?php echo $colorBorderError; ?>);
	border-bottom: solid 1px rgb(<?php echo $colorBorderError; ?>);
	padding-top: 8px;
	padding-left: 10px;
	padding-right: 4px;
	padding-bottom: 8px;
	margin: 1em 0em 1em 0em;
	background-image: -o-linear-gradient(bottom,		rgba(<?php echo $colorBackError; ?>, 0.1) 0%, rgba(<?php echo $colorBackError; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(bottom,		rgba(<?php echo $colorBackError; ?>, 0.1) 0%, rgba(<?php echo $colorBackError; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(bottom,	rgba(<?php echo $colorBackError; ?>, 0.1) 0%, rgba(<?php echo $colorBackError; ?>, 1) 100%) !important;
	background-image: -ms-linear-gradient(bottom,		rgba(<?php echo $colorBackError; ?>, 0.1) 0%, rgba(<?php echo $colorBackError; ?>, 1) 100%) !important;
	background-image: linear-gradient(to bottom,		rgba(<?php echo $colorBackError; ?>, 0.1) 0%, rgba(<?php echo $colorBackError; ?>, 1) 100%) !important;
}
...
.infras img, .classfortooltip img, .img16 {
	max-height: 16px;
}
...
.cke_top {
	background-image: -o-linear-gradient(bottom,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(bottom,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(bottom,	rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: -ms-linear-gradient(bottom,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-image: linear-gradient(to bottom,		rgba(<?php echo $colorbacktitle1; ?>, 0.1) 0%, rgba(<?php echo $colorbacktitle1; ?>, 1) 100%) !important;
	background-repeat: repeat-x;
...
.select2-container--default .select2-results__option[aria-selected=true] {
	background-color: transparent;
	background-image: -o-linear-gradient(bottom,		rgba(<?php echo $colorbacklinepairchecked; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairchecked; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(bottom,		rgba(<?php echo $colorbacklinepairchecked; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairchecked; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(bottom,	rgba(<?php echo $colorbacklinepairchecked; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairchecked; ?>, 1) 100%) !important;
	background-image: -ms-linear-gradient(bottom,		rgba(<?php echo $colorbacklinepairchecked; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairchecked; ?>, 1) 100%) !important;
	background-image: linear-gradient(to bottom,		rgba(<?php echo $colorbacklinepairchecked; ?>, 0.1) 0%, rgba(<?php echo $colorbacklinepairchecked; ?>, 1) 100%) !important;
	color: rgb(<?php echo $colortextlink ?>);
 }
