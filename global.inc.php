...
table.liste, table.noborder, table.formdoc, div.noborder {
	...
	border-right-color: rgb(<?php echo $colortopbordertitle1 ?>);
...
.liste_titre_filter {
	background-image: -o-linear-gradient(top,		rgba(<?php echo $colorbackhmenu1; ?>, 0.1) 0%, rgba(<?php echo $colorbackhmenu1; ?>, 1) 100%) !important;
	background-image: -moz-linear-gradient(top,		rgba(<?php echo $colorbackhmenu1; ?>, 0.1) 0%, rgba(<?php echo $colorbackhmenu1; ?>, 1) 100%) !important;
	background-image: -webkit-linear-gradient(top,	rgba(<?php echo $colorbackhmenu1; ?>, 0.1) 0%, rgba(<?php echo $colorbackhmenu1; ?>, 1) 100%) !important;
...
.select2-container--default .select2-results__option--highlighted[aria-selected] {
	background-color: transparent;
	background-image: -o-linear-gradient(bottom, rgba(109, 70, 140, 0.3) 0%, rgba(109, 70, 140, 1) 100%);
	background-image: -moz-linear-gradient(bottom, rgba(109, 70, 140, 0.3) 0%, rgba(109, 70, 140, 1) 100%);
	background-image: -webkit-linear-gradient(bottom, rgba(109, 70, 140, 0.3) 0%, rgba(109, 70, 140, 1) 100%);
	background-image: -ms-linear-gradient(bottom, rgba(109, 70, 140, 0.3) 0%, rgba(109, 70, 140, 1) 100%);
	background-image: linear-gradient(to bottom, rgba(109, 70, 140, 0.3) 0%, rgba(109, 70, 140, 1) 100%);
	background-repeat: repeat-x;
  color: white; }
