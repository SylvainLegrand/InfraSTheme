...
print_barre_liste($text, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, "", $num, $nbtotalofrecords, 'title_user', 0, $morehtmlright.' '.$newcardbutton, '', $limit);	// InfraS change "title_generic => title_user"
