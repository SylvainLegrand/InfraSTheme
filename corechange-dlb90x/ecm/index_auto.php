...
print load_fiche_titre($langs->trans("ECMArea").' - '.$langs->trans("ECMFileManager"),'','title_ecm.png');	// InfraS ajout
$head = ecm_prepare_dasboard_head('');
//dol_fiche_head($head, 'index_auto', $langs->trans("ECMArea").' - '.$langs->trans("ECMFileManager"), -1, '');	// InfraS change
dol_fiche_head($head, 'index_auto', '', -1, '');	// InfraS change
