...
?>
    <tr class="<?php echo $trclass; ?>" >
    	...
    	<td class="linkedcol-ref center"><?php echo $objectlink->ref_client; ?></td>	// InfraS change
    	<td class="linkedcol-date center"><?php echo dol_print_date($objectlink->date, 'day'); ?></td>	// InfraS change
...
if (count($linkedObjectBlock) > 1)
{
    ...
    <tr class="liste_total <?php echo (empty($noMoreLinkedObjectBlockAfter)?'liste_sub_total':''); ?>">
        ...
        <td></td>
    	<td class="center"></td>	// InfraS change
    	<td class="center"></td>	// InfraS change
