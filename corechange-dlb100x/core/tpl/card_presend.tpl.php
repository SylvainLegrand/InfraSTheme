...
if ($action == 'presend')
{
	...
	$onlylastname = empty($conf->global->MAIN_ONLY_LAST_NAME_ON_MAIL) ? -1 : 4;	// InfraS add
	...
	if (is_array($contactarr) && count($contactarr) > 0) {
		...
		foreach ($contactarr as $contact) {
            ...
            $substitutionarray['__CONTACT_NAME_'.$contact['code'].'__'] = $contactstatic->getFullName($outputlangs, 1, $onlylastname);	// InfraS change
		}
	}
