...
if ($resql)
{
    ...
    print_barre_liste($text, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, "", $num, $nbtotalofrecords, 'title_users', 0, $newcardbutton, '', $limit);	// InfraS change "title_generic => title_users"
