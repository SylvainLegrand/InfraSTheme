    ...
    else
    {
        ...
        while ($i <= 6)
        {
            ...
            if ($idprof!='-')
            {
				...
				{
					if ($i == 1 && dol_strlen($profID) == 9)	$profID	= substr($profID, 0, 3).'&nbsp;'.substr($profID, 3, 3).'&nbsp;'.substr($profID, 6, 3);
					if ($i == 2 && dol_strlen($profID) == 14)	$profID	= substr($profID, 0, 3).'&nbsp;'.substr($profID, 3, 3).'&nbsp;'.substr($profID, 6, 3).'&nbsp;'.substr($profID, 9, 5);
				}	// if (strtoupper($object->country_code) == "FR")
				print $profID;
