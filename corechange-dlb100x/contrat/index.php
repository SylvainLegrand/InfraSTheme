...
if ($result)
{
	...
	print '<tr class="liste_titre"><th colspan="3">'.$langs->trans("LastContracts", 5).'</th>';	// InfraS change colspan 2 to 3
	//print '<th class="center">'.$langs->trans("DateModification").'</th>';	// InfraS change
	//print '<th class="left">'.$langs->trans("Status").'</th>';
	print '<th class="center" width="80" colspan="4">'.$langs->trans("Services").'</th>';
	print '</tr>';	// InfraS change
	...
	{	// InfraS add
		while ($i < $num)
		{
			...
			print '<tr class="oddeven">';
			print '<td width="20%" class="nowrap">';	// InfraS change 110 to 20%
...
if ($resql)
{
	...
	print '<tr class="liste_titre"><th colspan="4">'.$langs->trans("NotActivatedServices").' <a href="'.DOL_URL_ROOT.'/contrat/services_list.php?mode=0">'.($num?' <span class="badge">'.$num.'</span>':'').'</a></th>';	// InfraS change
	print "</tr>\n";
	...
	else	print '<tr class="oddeven"><td colspan="3" class="opacitymedium">'.$langs->trans("NoServiceNotActivated").'</td></tr>';	// InfraS add
	$db->free();
...
if ($resql)
{
	...
	print '<tr class="liste_titre"><th colspan="4">'.$langs->trans("ListOfExpiredServices").' <a href="'.DOL_URL_ROOT.'/contrat/services_list.php?mode=4&amp;filter=expired">'.($num?' <span class="badge">'.$num.'</span>':'').'</a></th>';	// InfraS change
	print "</tr>\n";
