...
.bg-infoxbox-supplier_proposal{
	background-image: url("img/supplierproposal.png");
}
.bg-infoxbox-invoice_supplier{
	background-image: url("img/supplierinvoice.png");
}
.bg-infoxbox-order_supplier{
	background-image: url("img/supplierorder.png");
}
.bg-infoxbox-contrat{
...
.bg-infoxbox-expensereport{
	background-image: url("img/expensereport.png");
	<?php echo $prefix; ?>color: <?php print colorAgressiveness('#79633f', $conf->global->THEME_AGRESSIVENESS_RATIO); ?>  !important;
}
.bg-infoxbox-holiday{
	background-image: url("img/holidays.png");
